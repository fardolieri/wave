<template>
  <div class="column no-wrap fit overflow-hidden">
            ...
            <q-item-section side v-if="friend.status === 'friend'">
              ...
              <q-menu auto-close :offset="[-18, -8]">
                <q-list style="min-width: 150px">
                  <q-item clickable @click="copyToClipboard(friend.id)">
                  ...
                  <q-item clickable>
                    <q-item-section @click="friend.ignore()"
                      >Ignore</q-item-section
                    >
                  </q-item>
                  <q-item clickable>
            ...
            >
              <q-btn-group push>
                ...
                <q-btn
                  ...
                  @click="friend.ignore()"
                >
                  <q-tooltip>Ignore</q-tooltip></q-btn
                >
              </q-btn-group>
            </q-item-section>
            <q-item-section
    ...
    <ignored-contacts></ignored-contacts>
  </div>
</template>
...
import IgnoredContacts from './IgnoredContacts.vue';
